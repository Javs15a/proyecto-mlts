...
create table persona(
       ...
       tipo_persona varchar(20) not null, --(cliente o proveedor)
...
-- Categoria
insert into categoria (nombre, descripcion) values ('Electrónica', null);
...
insert into categoria (nombre, descripcion) values ('Línea Blanca', null);
insert into categoria (nombre, descripcion) values ('Música', null);
...
-- Artículos
insert into articulo (idcategoria, codigo, nombre, descripcion, precio_venta, stock) values (1, '1765227224', 'Audífonos Hyper X', 'HyperX Cloud Stinger - Audífonos para gaming –', 591.51, 260);
insert into articulo (idcategoria, codigo, nombre, descripcion, precio_venta, stock) values (2, '2143167334', 'Neumáticos Continental', '205/55r16 Continental Premium Contact', 1164.36, 324);
...
insert into articulo (idcategoria, codigo, nombre, descripcion, precio_venta, stock) values (5, '3813098028', 'Sartenes Vasconia', 'Juego de sartenes de teflón', 436.59, 831);
insert into articulo (idcategoria, codigo, nombre, descripcion, precio_venta, stock) values (6, '2257346165', 'Shampoo Sedal', 'Bote de 750ml', 92.38, 616);
...
insert into articulo (idcategoria, codigo, nombre, descripcion, precio_venta, stock) values (8, '0063020807', 'Batería Musical Acústica', '5 piezas Tambor Bombo Toms Platillos', 1491.9, 339);
...
insert into articulo (idcategoria, codigo, nombre, descripcion, precio_venta, stock) values (10, '0886286786', 'Taladro Black and Decker', 'Con batería de ion de litio recargable de 12V para uso inalámbrico',  1360.4, 612);

-- Roles
insert into rol (nombre, descripcion) values ('Administrador', 'Tiene acceso a todo el sistema');
insert into rol (nombre, descripcion) values ('Gerente', 'Tiene acceso a creación y modificación de todos las entidades en el sistema');
insert into rol (nombre, descripcion) values ('Empleado', 'Tiene acceso suficiente para cumplir la tarea de ventas');
